...
function extractModel(absolutePath) {
  ...
  if (!model) {
    throw new Error("CollectionBuilderError: An error occured extracting the Model from the slug parts. This is likely a bug within Gatsby and not your code. Please report it to us if you run into this.");
  }
...
function extractAllCollectionSegments(absolutePath) {
  ...
  if (!slugParts) {
    throw new Error("CollectionBuilderError: An error occured building the slug parts. This is likely a bug within Gatsby and not your code. Please report it to us if you run into this.");
  }
