...
function collectionExtractQueryString(absolutePath) {
        ...
        path.traverse({
          TaggedTemplateExpression: function TaggedTemplateExpression(path) {
            ...
            if (text.includes("...CollectionPagesQueryFragment") === false) {
              throw new Error("Your collection graphql query is incorrect. You must use the fragment \"...CollectionPagesQueryFragment\" to pull data nodes");
            }
