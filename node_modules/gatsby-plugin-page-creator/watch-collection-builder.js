 ...
 */
function watchCollectionBuilder(absolutePath, previousQueryString, paths, actions, rerunCollectionBuilder) {
  var watcher = _chokidar.default.watch(absolutePath).on("change", function () {
    var queryString = (0, _collectionExtractQueryString.collectionExtractQueryString)(absolutePath); // if the users is changing the query to generate the pages, we need to delete the old pages
