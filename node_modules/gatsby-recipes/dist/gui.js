...
const RecipeInterpreter = () => {
  var _state$context$plan2, _state$context$plan3;
  ...
  return (0, _themeUi.jsx)(React.Fragment, null, (0, _themeUi.jsx)(_themeUi.Styled.p, null, ` `), (0, _themeUi.jsx)(_resourceProvider.ResourceProvider, {
    ...
    remarkPlugins: [removeJsx]
  }, state.context.recipe)), (0, _themeUi.jsx)(Button, {
    onClick: () => sendEvent({
      event: `CONTINUE`
    }),
  ...
  }, state.context.stepsAsMdx.length - 1, " Steps"), state.context.stepsAsMdx.slice(1).map((step, i) => (0, _themeUi.jsx)(Step, {
    state: state,
    step: step,
    key: `step-${i}`,
    i: i
