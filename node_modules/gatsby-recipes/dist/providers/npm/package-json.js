...
class Deferred {
  constructor(name) {
    ...
    this.name = name; // bind `then` and `catch` to implement the same interface as Promise
...
const checkWritesQueue = async root => new Promise((resolve, reject) => {
  setTimeout(async () => {
